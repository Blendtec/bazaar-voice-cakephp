		...
		<?php foreach ($products as $product): ?>
			<Product>
				...
				<ManufacturerPartNumbers>
					<ManufacturerPartNumber><?php echo $product['Product']['manufacturer_part_number']; ?></ManufacturerPartNumber>
				</ManufacturerPartNumbers>
				<?php if (isset($product['Product']['upc']) && !empty($product['Product']['upc'])): ?>
					<UPCs>
				...
				<?php endif; ?>
				<?php if (isset($product['Product']['isbn']) && !empty($product['Product']['isbn'])): ?>
					<ISBNs>
						<ISBN><?php echo $product['Product']['isbn']; ?></ISBN>
					</ISBNs>
				<?php endif; ?>
				<ModelNumbers>
